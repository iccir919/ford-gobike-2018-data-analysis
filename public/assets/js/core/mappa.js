          ...
          },
          {
            ...
            value: function latLngToPixel() {
              ...
              if (_typeof(args[0]) === "object") {
                ...
                pos = { lat: Number(args[0]), lng: Number(args[1]) };
              }
              ...
              value: function fromPointToLatLng() {
                if (this.ready) {
                  ...
                  var point = new google.maps.Point(
                    (arguments.length <= 0 ? undefined : arguments[0]) / scale +
                      bottomLeft.x,
                    (arguments.length <= 1 ? undefined : arguments[1]) / scale +
                      topRight.y
                  );
                  var latlng = this.map
                    .getProjection()
          ...
          [
            {
              ...
              value: function createMap() {
                ...
                if (this.options.studio) {
                  this.tiles = L.mapbox
                    .styleLayer(
                      this.options.style || "mapbox://styles/mapbox/emerald-v8"
                    )
                    .addTo(this.map);
                } else {
                  this.tiles = L.mapbox
